...
![Fig. F2.0.1 Mapped color-IR images from multiple satellite sensors that we mapped in Chap. F1.3. The near infrared spectrum is mapped as red, showing where there are high amounts of healthy vegetation.](../images/F2/image39.png)
...
![Fig. F2.0.2 A graph of the amount of reflectance for different objects on the Earth’s surface at different wavelengths in the visible and infrared portions of the electromagnetic spectrum. 1 micrometer (µm) = 1,000 nanometers (nm).](../images/F2/image32.png)
...
```
![Fig. F2.0.3 False color Sentinel-2 imagery of San Francisco and surroundings](../images/F2/image46.png)
...
![Fig. F2.0.4 NDVI calculated using Sentinel-2. Remember that outputs for NDVI vary between −1 and 1. High amounts of green vegetation have values around 0.8–0.9. Absence of green leaves gives values near 0, and water gives values near −1.](../images/F2/image50.png)
...
![Fig. F2.0.5 NDWI displayed for Sentinel-2 over San Francisco](../images/F2/image40.png)
...
```
![Fig. F2.0.6 NDVI image of Sentinel-2 imagery over Seattle, Washington, USA](../images/F2/image30.png)
...
![Fig. F2.0.7 Thresholded forest and non-forest image based on NDVI for Seattle, Washington, USA](../images/F2/image47.png)
...
![Fig. F2.0.8 Thresholded water, forest, and non-forest image based on NDVI for Seattle, Washington, USA.](../images/F2/image37.png)
...
```
![Fig. F2.0.9 The existing mask for the seaVeg layer we created previously](../images/F2/image23.png)
...
![Fig. F2.0.10 An updated mask now displays only the forested areas. Non-forested areas are masked out and transparent.](../images/F2/image26.png)
...
```
![Fig. F2.0.11 The updated mask. Areas of non-forest are now masked out as well (black areas of the image).](../images/F2/image33.png)
...
![Fig. F2.1.1 Image classification concept](../images/F2/image48.png)
...
```
![Fig. F2.1.2 Landsat image](../images/F2/image44.png)
...
![Fig. F2.1.3 Creating a new layer in the Geometry Imports](../images/F2/image22.png)
...
![Fig. F2.1.4 Edit geometry layer properties](../images/F2/image36.png)
...
![Fig. F2.1.5 Activate forest layer to start collection](../images/F2/image29.png)
...
![Fig. F2.1.7 New layer option in Geometry Imports](../images/F2/image41.png)
...
![Fig. F2.1.8 Example of training points](../images/F2/image42.png)
...
![Fig. F2.1.9 Example of extracted band information for one point of class 0 (forest)](../images/F2/image20.png)
...
![Fig. F2.1.10 Example of a decision tree for satellite image classification. Values and classes are hypothetical.](../images/F2/image25.png)
...
![Fig. F2.1.11 CART classification](../images/F2/image21.png)
...
![Fig. F2.1.13 Random Forest classified image](../images/F2/image34.png)
...
![Fig. F2.1.14 K-means visual concept](../images/F2/image35.png)
...
```
![Fig. F2.1.15 K-means classification](../images/F2/image31.png)
...
![](../images/F2/image6.png)


In this case, the overall accuracy is 96.8%, calculated using (![](../images/F2/image7.png).
...
![](../images/F2/image8.png)


![](../images/F2/image9.png)


In this case, the producer’s accuracy for the forest class is 95.6%, calculated using ![](../images/F2/image10.png)). The producer’s accuracy for the non-forest class is 97.3%, calculated from ![](../images/F2/image11.png)).
...
![](../images/F2/image12.png)


![](../images/F2/image13.png)


In this case, the user’s accuracy for the forest class is 94.5%, calculated using ![](../images/F2/image14.png)). The user’s accuracy for the non-forest class is 97.9%, calculated from ![](../images/F2/image15.png)).


Fig. F2.2.1 helps visualize the rows and columns used to calculate each accuracy.


![Fig. F2.2.1 Confusion matrix for a binary classification where the classes are “positive” (forest) and “negative” (non-forest), with accuracy metrics](../images/F2/image43.png)
...
```
![Fig. F2.2.2 Chart showing accuracy per number of Random Forest trees](../images/F2/image45.png)
