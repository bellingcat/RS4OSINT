...
\markright{Assumes you know how to:}
...
\markright{Introduction to Theory}
...
\includegraphics{./F2/image50.png}
...
\includegraphics{./F2/image40.png}
...
\includegraphics{./F2/image30.png}
...
\includegraphics{./F4/image45.png}
...
var~styles = ee.Dictionary(\{~ ~`S1100': \{~ ~ ~ ~`color': `blue',~ ~ ~
~`width': 3~ ~\},~ ~`S1200': \{~ ~ ~ ~`color': `green',~ ~ ~ ~`width':
2~ ~\},~ ~`S1400': \{~ ~ ~ ~`color': `orange',~ ~ ~ ~`width': 1~ ~\}\\
\});var~defaultStyle = \{\\
\hspace*{0.333em} ~color: `gray',~ ~`width': 1\\
\};
...
\includegraphics{./F5/image3.png}

Fig. F5.3.10~Exported CSV file with tree counts for San Francisco
neighborhoods
...
\includegraphics{./F6/image54.png}
...
\includegraphics{./F6/image57.png}
...
* ~ ~ fontSize ~ ~ ~ - 16\textbar18\textbar24\textbar32 - the size of
the font (default: 16)\\
...
\addcontentsline{toc}{chapter}{Refinery Detection}

\markboth{Refinery Detection}{Refinery Detection}
